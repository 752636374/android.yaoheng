...
public class MySqlConn{
	...
	//
	public StringBuilder tag_FETALPACKET() throws SQLException{
		Connection connection=getConn();
		String sql="select * from tag_FETALPACKET";
		PreparedStatement preparedStatement;
		StringBuilder builder=new StringBuilder();
		preparedStatement=(PreparedStatement) connection.prepareStatement(sql);
		ResultSet resultSet=preparedStatement.executeQuery();
	...
	public StringBuilder tag_ETCOPACKET() throws SQLException{
		Connection connection=getConn();
		String sql="select * from tag_ETCOPACKET";
		PreparedStatement preparedStatement;
		StringBuilder builder=new StringBuilder();
		preparedStatement=(PreparedStatement) connection.prepareStatement(sql);
		ResultSet resultSet=preparedStatement.executeQuery();
	...
	public StringBuilder tag_BPBOPACEKT() throws SQLException{
		Connection connection=getConn();
		String sql="select * from tag_BPBOPACEKT";
		PreparedStatement preparedStatement;
		StringBuilder builder=new StringBuilder();
		preparedStatement=(PreparedStatement) connection.prepareStatement(sql);
		ResultSet resultSet=preparedStatement.executeQuery();
