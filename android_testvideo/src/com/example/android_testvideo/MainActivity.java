package com.example.android_testvideo;
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				if (progressDialog == null) {
					progressDialog = ProgressDialog.show(MainActivity.this, "视频缓存", "正在努力加载中 ...", true, false);
				}
			}
		});
	}
